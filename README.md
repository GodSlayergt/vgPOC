...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/napEOgLyv5)
...
```sh
npx nx serve vgPOCNative
```

To create a production bundle:

```sh
npx nx build vgPOCNative
```

To see all available targets to run for a project, run:

```sh
npx nx show project vgPOCNative
```
